...
description: "How Boolean algebra lets us describe, evaluate, and build logic circuits using expressions like x = AB + C."
date: 2025-01-20
author: "Rizki Kadafi"
categories:
  - lower-level
...
<figure>
  <img src="/blog/assets/images/posts/bool-expression.png" alt="(a) Logic circuit with its Boolean expression" />
  <figcaption>(a) Logic circuit with its Boolean expression</figcaption>
</figure>
...
<figure>
  <img src="/blog/assets/images/posts/bool-expression-parentheses.png" alt="(b) logic circuit whose expression requires parentheses." />
  <figcaption>(b) logic circuit whose expression requires parentheses.</figcaption>
</figure>
...
<figure>
  <img src="/blog/assets/images/posts/constructing-logic-circuit.png" alt="Constructing a logic circuit from a Boolean expression." />
  <figcaption>Constructing a logic circuit from a Boolean expression.</figcaption>
</figure>
