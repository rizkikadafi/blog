...
description: "An introduction to the three basic logic gates — OR, AND, and NOT — with truth tables, analogies, and symbols."
date: 2025-01-18
author: "Rizki Kadafi"
categories:
  - lower-level
...
<figure>
  <img src="/blog/assets/images/posts/or-gate.png" alt="(a) Truth table defining the OR operation; (b) circuit symbol for a two-input OR gate." />
  <figcaption>(a) Truth table defining the OR operation; (b) circuit symbol for a two-input OR gate.</figcaption>
</figure>
...
<figure>
  <img src="/blog/assets/images/posts/and-gate.png" alt="(a) Truth table for the AND operation; (b) AND gate symbol." />
  <figcaption>(a) Truth table for the AND operation; (b) AND gate symbol.</figcaption>
</figure>
...
<figure>
  <img src="/blog/assets/images/posts/not-gate.png" alt="(a) Truth table; (b) symbol for the INVERTER (NOT circuit)" />
  <figcaption>(a) Truth table; (b) symbol for the INVERTER (NOT circuit)</figcaption>
</figure>
